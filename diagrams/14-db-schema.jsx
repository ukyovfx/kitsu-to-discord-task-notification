const DBSchema = () => {
    return (
        <section className="doc" id="db-schema">
            ...
            <h2 className="docsub">Phase 2-2 ?????????????????????</h2>
            ...
            <div style={{display: 'flex', gap: '24px', flexWrap: 'wrap'}}>
                ...
                <div className="er-table">
                    ...
                    <div className="row"><span>?</span><span>kitsu.hostname</span></div>
                    <div className="row"><span>?</span><span>kitsu.email</span></div>
                    <div className="row"><span>?</span><span>discord.guildID</span></div>
                </div>
            </div>
            ...
            <div className="wf wf-pad box" style={{marginTop: '32px'}}>
                ...
                <ul style={{margin: 0, paddingLeft: '20px', fontSize:'12px', lineHeight:'1.9'}}>
                    <li><code>project_dcc_tools</code> ?????? DCC ?????????????</li>
                    <li><code>file_path_presets</code> ? UI ??????????????? seed ?????</li>
                    <li><code>settings</code> ? live config ?????secret ??????????????????</li>
